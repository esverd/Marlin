...
#define STRING_CONFIG_H_AUTHOR "(SCARA Drawing Arm)" // Original author or contributor.
...
//#define MP_SCARA
  ...
  #define SCARA_LINKAGE_1 116       // (mm)
  #define SCARA_LINKAGE_2 114       // (mm)
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 13.333, 13.333, 400 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 25, 25, 3 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 100, 100, 60 }
 ...
 */
#define DEFAULT_ACCELERATION          100     // X, Y, Z acceleration for printing moves
...
#define NO_MOTION_BEFORE_HOMING  // Inhibit movement until required axes have been homed.
